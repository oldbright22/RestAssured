...
public class E_JSON_RetrieveIncidents_MultipleQP_GET {
	...
	public void incident_retrieval() {
		  ...
		  multipleQP.put("sysparm_fields", "sys_id,short_description,description,number");
		  multipleQP.put("sysparm_limit",  "2");
